...
namespace DemoCutterGUI
{
    ...
    public class DatabaseFieldInfo : INotifyPropertyChanged // Used for search
    {
        ...
        public enum FieldSubCategory
        {
            ...
            FlagGrabs_Meta = Column1,
            FlagGrabs_Grab = Column2,
            FlagGrabs_Movement = Column3,
        ...
        public static DatabaseFieldInfo[] GetDatabaseFieldInfos()
        {
            return new DatabaseFieldInfo[] {
                ...
                new DatabaseFieldInfo(){ FieldName="sameFrameCap", Nullable = true, Bool = true, Category=FieldCategory.Captures,SubCategory=FieldSubCategory.Captures_Capture},
                ...
                new DatabaseFieldInfo(){ FieldName="boosts", Nullable = true, Bool = false, Category=FieldCategory.Captures, SubCategory=FieldSubCategory.Captures_Movement, Numeric=false},
                new DatabaseFieldInfo(){ FieldName="boostCount", Nullable = false, Bool = false, Category=FieldCategory.Captures, SubCategory=FieldSubCategory.Captures_Movement, Numeric=true},
                ...
                new DatabaseFieldInfo(){ FieldName="pastLocations", Nullable = true, Bool = false, Category=FieldCategory.Captures, SubCategory=FieldSubCategory.Captures_Movement},
                ...
                // Flag grabs
                new DatabaseFieldInfo(){ FieldName="id", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="map", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="serverName", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="serverNameStripped", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="enemyFlagHoldTime", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="flagPickupSource", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="grabberName", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="grabberNameStripped", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperName", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperNameStripped", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="grabberClientNum", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperClientNum", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="grabberIsVisible", Nullable = false, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="grabberIsFollowed", Nullable = false, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="grabberIsFollowedOrVisible", Nullable = false, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperIsVisible", Nullable = true, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperIsFollowed", Nullable = true, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperIsFollowedOrVisible", Nullable = true, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperWasVisible", Nullable = true, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperWasFollowed", Nullable = true, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="capperWasFollowedOrVisible", Nullable = true, Bool = true, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="demoRecorderClientnum", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="flagTeam", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperKills", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperRets", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="redScore", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="blueScore", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="redPlayerCount", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="bluePlayerCount", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="sumPlayerCount", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="boosts", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=false},
                new DatabaseFieldInfo(){ FieldName="boostCount", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="maxSpeedGrabberLastSecond", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="maxSpeedCapperLastSecond", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="maxSpeedCapper", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="averageSpeedCapper", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="metaEvents", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="nearbyPlayers", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="nearbyPlayerCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="nearbyEnemies", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab},
                new DatabaseFieldInfo(){ FieldName="nearbyEnemyCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="veryCloseEnemyCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="veryClosePlayersCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="padNearbyPlayers", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="padNearbyPlayerCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="padNearbyEnemies", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab},
                new DatabaseFieldInfo(){ FieldName="padNearbyEnemyCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="padVeryCloseEnemyCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="padVeryClosePlayersCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="maxNearbyEnemyCount", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="moreThanOneNearbyEnemyTimePercent", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="averageNearbyEnemyCount", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="maxVeryCloseEnemyCount", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="anyVeryCloseEnemyTimePercent", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="moreThanOneVeryCloseEnemyTimePercent", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="averageVeryCloseEnemyCount", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperPadDistance", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperTimeToCap", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Grab, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="directionX", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="directionY", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="directionZ", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="positionX", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="positionY", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="positionZ", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperDirectionX", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperDirectionY", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperDirectionZ", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperPositionX", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperPositionY", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="capperPositionZ", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="resultingCaptures", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="resultingSelfCaptures", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="resultingEnemyCaptures", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Movement, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="resultingLaughs", Nullable = true, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="demoName", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="demoPath", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta},
                new DatabaseFieldInfo(){ FieldName="demoTime", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="lastGamestateDemoTime", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="serverTime", Nullable = false, Bool = false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="demoDateTime", Nullable = false, Bool =false, Category=FieldCategory.FlagGrabs, SubCategory=FieldSubCategory.FlagGrabs_Meta, Numeric=true},
                ...
                new DatabaseFieldInfo(){ FieldName="serverName", Nullable = false, Bool = false, Category=FieldCategory.KillSprees,SubCategory=FieldSubCategory.KillSprees_Meta},
                new DatabaseFieldInfo(){ FieldName="serverNameStripped", Nullable = false, Bool = false, Category=FieldCategory.KillSprees,SubCategory=FieldSubCategory.KillSprees_Meta},
                ...
                new DatabaseFieldInfo(){ FieldName="runTeleProRun", Nullable = true, Bool = true, Category=FieldCategory.DefragRuns, SubCategory=FieldSubCategory.Defrag_Run},
                new DatabaseFieldInfo(){ FieldName="runTeleTeleports", Nullable = true, Bool = false, Category=FieldCategory.DefragRuns, SubCategory=FieldSubCategory.Defrag_Run, Numeric=true},
                new DatabaseFieldInfo(){ FieldName="runTeleCheckpoints", Nullable = true, Bool = false, Category=FieldCategory.DefragRuns, SubCategory=FieldSubCategory.Defrag_Run, Numeric=true},
