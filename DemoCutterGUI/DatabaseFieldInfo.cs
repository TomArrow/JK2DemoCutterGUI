    ...
    public class DatabaseFieldInfo : INotifyPropertyChanged // Used for search
    {
        ...
        public static DatabaseFieldInfo[] GetDatabaseFieldInfos()
        {
            return new DatabaseFieldInfo[] {
                ...
                // Kills
                new DatabaseFieldInfo(){ FieldName="hash", Nullable = true, Bool = false, Category="Kills",SubCategory="Names"},
                new DatabaseFieldInfo(){ FieldName="shorthash", Nullable = true, Bool = false, Category="Kills",SubCategory="Names"},
                ...
                new DatabaseFieldInfo(){ FieldName="killerTeam", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="victimTeam", Nullable = false, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="redScore", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="blueScore", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="otherFlagStatus", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="redPlayerCount", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="bluePlayerCount", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="sumPlayerCount", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="killerClientNum", Nullable = false, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="victimClientNum", Nullable = false, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="isDoomKill", Nullable = false, Bool = true, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="isExplosion", Nullable = false, Bool = true, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="isSuicide", Nullable = false, Bool = true, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="isModSuicide", Nullable = false, Bool = true, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="meansOfDeath", Nullable = false, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="positionX", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="positionY", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="positionZ", Nullable = true, Bool = false, Category="Kills",SubCategory=""},
                ...
                new DatabaseFieldInfo(){ FieldName="victimCapperKills", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="victimCapperRets", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                ...
                new DatabaseFieldInfo(){ FieldName="victimFlagPickupSource", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="victimFlagHoldTime", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="targetIsVisible", Nullable = false, Bool = true, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="targetIsFollowed", Nullable = false, Bool = true, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="targetIsFollowedOrVisible", Nullable = false, Bool = true, Category="KillAngles",SubCategory=""},
                ...
                new DatabaseFieldInfo(){ FieldName="attackerIsVisible", Nullable = false, Bool = true, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="attackerIsFollowed", Nullable = false, Bool = true, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="attackerIsFollowedOrVisible", Nullable = false, Bool = true, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="demoRecorderClientnum", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="boosts", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="boostCountTotal", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="boostCountAttacker", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="boostCountVictim", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="projectileWasAirborne", Nullable = true, Bool = true, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="baseFlagDistance", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="headJumps", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="specialJumps", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="timeSinceLastSelfSentryJump", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="resultingCaptures", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="resultingSelfCaptures", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="metaEvents", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="maxAngularSpeedAttacker", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="maxAngularAccelerationAttacker", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="maxAngularJerkAttacker", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="maxAngularSnapAttacker", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="maxSpeedAttacker", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="maxSpeedTarget", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="currentSpeedAttacker", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="currentSpeedTarget", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="lastSaberMoveChangeSpeed", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="timeSinceLastSaberMoveChange", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="timeSinceLastBackflip", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="meansOfDeathString", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="nearbyPlayers", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Names"},
                new DatabaseFieldInfo(){ FieldName="nearbyPlayerCount", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="probableKillingWeapon", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="attackerJumpHeight", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="victimJumpHeight", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="directionX", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="directionY", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="directionZ", Nullable = true, Bool = false, Category="KillAngles",SubCategory=""},
                ...
                new DatabaseFieldInfo(){ FieldName="demoTime", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="serverTime", Nullable = false, Bool = false, Category="KillAngles",SubCategory=""},
                new DatabaseFieldInfo(){ FieldName="demoDateTime", Nullable = false, Bool =false, Category="KillAngles",SubCategory=""},
