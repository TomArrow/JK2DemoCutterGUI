    ...
    public class DatabaseFieldInfo : INotifyPropertyChanged // Used for search
    {
        ...
        public static DatabaseFieldInfo[] GetDatabaseFieldInfos()
        {
            return new DatabaseFieldInfo[] {
                ...
                new DatabaseFieldInfo(){ FieldName="victimCapperWasFollowedOrVisible", Nullable = true, Bool = true, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimCapperMaxNearbyEnemyCount", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimCapperMoreThanOneNearbyEnemyTimePercent", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimCapperAverageNearbyEnemyCount", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimCapperMaxVeryCloseEnemyCount", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimCapperAnyVeryCloseEnemyTimePercent", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimCapperMoreThanOneVeryCloseEnemyTimePercent", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimCapperAverageVeryCloseEnemyCount", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimFlagPickupSource", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                new DatabaseFieldInfo(){ FieldName="victimFlagHoldTime", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                ...
                new DatabaseFieldInfo(){ FieldName="metaEvents", Nullable = true, Bool = false, Category="KillAngles",SubCategory="Kill"},
                ...
                new DatabaseFieldInfo(){ FieldName="demoTime", Nullable = false, Bool = false, Category="KillAngles",SubCategory="Names"},
                new DatabaseFieldInfo(){ FieldName="serverTime", Nullable = false, Bool = false, Category="KillAngles",SubCategory="Names"},
                new DatabaseFieldInfo(){ FieldName="demoDateTime", Nullable = false, Bool =false, Category="KillAngles",SubCategory="Names"},
